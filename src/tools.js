...
function showHitokoto() {
    ...
    fetch("https://v1.hitokoto.cn")
        ...
        .then(result => {
            const text = `This sentence comes from <span>「${result.from}」</span>，Yes <span>${result.creator}</span> contributed at hitokoto.cn。`;
...
const tools = {
    ...
    "info": {
        icon: fa_info_circle,
        callback: () => {
            open("https://github.com/0x5h1n0k0/live2d-hexo");
        }
    },
    "quit": {
        icon: fa_xmark,
